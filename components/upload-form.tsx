...
export default function UploadForm({ onSuccess }: { onSuccess: () => void }) {
    ...
    return (
        <div className="p-8 rounded-2xl bg-gradient-to-br from-slate-900/50 to-slate-800/50 border border-white/10 backdrop-blur-xl">
            <h2 className="text-2xl font-bold mb-6 bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">Upload Material</h2>
